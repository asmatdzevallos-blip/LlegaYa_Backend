...
SECRET_KEY = 'django-insecure-w$u4w&@98)d^n$(aq#y6nvx0nu7f#f=+cw+1t-$mh!vbo(as*h'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'postgres',      # el nombre que le pongas en DBeaver
        'USER': 'postgres.rxfvcfmtdtqxswpgoqdp',
        'PASSWORD': 'llegaya123.', # tu contraseña de PostgreSQL
